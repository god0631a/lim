			...
			<div class="container-fluid">
                ...
                <div class="collapse navbar-collapse js-navbar-collapse">
                		<ul class="nav navbar-nav navbar-left">
                			<a class="navbar-brand" href="managementpage.jsp">
                			...
                			<li class="dropdown mega-dropdown">
                				<a href="#" class="dropdown-toggle" data-toggle="dropdown">책 관리 <span class="caret"></span></a>				
                				<ul class="dropdown-menu mega-dropdown-menu">
                					...
                					<li class="col-sm-3">
                						<ul>
                							<li class="dropdown-header">책 관리</li>
                							<li><a href="interinputbook.jsp">도서 등록</a></li>
                                            <li><a href="update.jsp">도서 변경</a></li>
                                            <li><a href="delete.jsp">도서 삭제</a></li>
                							<li><a href="select.jsp">도서 검색</a></li>   
                							<li class="divider"></li>
                							<li class="dropdown-header">고객 관리</li>
                                            <li><a href="#">고객 등급 관리</a></li>
                							<li><a href="#">고객 실적 확인</a></li>
                							<li><a href="list.jsp">고객 센터 확인</a></li>
                						</ul>
                					</li>
                					<li class="col-sm-3">
                                            ...
                                            <div id="womenCollection" class="carousel slide" data-ride="carousel">
                                              <div class="carousel-inner">
                                                <div class="item active">
                                                    ...
                                                    <h4><small>Summer dress floral prints</small></h4>                                        
                                                    <button class="btn btn-primary" type="button">4,999원</button> <button href="#" class="btn btn-default" type="button"><span class="glyphicon glyphicon-heart"></span> Add to Wishlist</button>       
                                                </div><!-- End Item -->
                                                <div class="item">
                                                    <a href="#"><img src="http://placehold.it/254x150/ff3546/f5f5f5/&text=New+Collection" class="img-responsive" alt="product 2"></a>
                                                    <h4><small>Gold sandals with shiny touch</small></h4>                                        
                                                    <button class="btn btn-primary" type="button">9,999원</button> <button href="#" class="btn btn-default" type="button"><span class="glyphicon glyphicon-heart"></span> Add to Wishlist</button>        
                                                </div><!-- End Item -->
                                                <div class="item">
                                                    <a href="#"><img src="http://placehold.it/254x150/2ecc71/f5f5f5/&text=New+Collection" class="img-responsive" alt="product 3"></a>
                                                    <h4><small>Denin jacket stamped</small></h4>                                        
                                                    <button class="btn btn-primary" type="button">493,399원</button> <button href="#" class="btn btn-default" type="button"><span class="glyphicon glyphicon-heart"></span> Add to Wishlist</button>      
                                                </div><!-- End Item -->                                
                                              </div><!-- End Carousel Inner -->
                                              <!-- Controls -->
				...
				<div class="modal-dialog modal-default">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">asdfsadf</button>
